...
@MyBook(name = "车子杰",authors = {"sadf","asda"})
public class Annotation{
    
}
```
#### 元注解
1. @Target：约束自定义注解的使用范围
